const e = {
  "will you be my valentine?":
    "https://media1.tenor.com/m/wrK_6KnCPhsAAAAC/cat-dance.gif",
  "think again":
  ...
  "let's celebrate love together":
    "https://media1.tenor.com/m/MHcdyIl-GGkAAAAC/mochi-mochimochi.gif",
  "my heart meows for you":
    "https://media1.tenor.com/m/XAabbheOS24AAAAC/goma-happy.gif",
  "you make my whiskers tingle":
    "https://media1.tenor.com/m/QL6iJs82s1gAAAAC/pusheen-cat.gif",
  "thousands please":
    "https://media1.tenor.com/m/Y3j6d3RoSEoAAAAC/sad-cat-content-aware-scale.gif",
  "Please say yes!":
    "https://media1.tenor.com/m/rKPIRDj0h0oAAAAC/crying-cat-blink.gif",
...
window.addEventListener("load", () => {
  ...
  document.getElementById("yes").addEventListener("click", () => {
    document.getElementById("message").textContent =
      "Appooo  Rajunte molke bhuddi Indalle!!!!!! <3";
